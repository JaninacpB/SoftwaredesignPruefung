...
var Test = /** @class */ (function () {
    ...
    Test.prototype.aufruf = function () {
        console.log('Test');
        var test = new Promise(function (resolve, reject) {
            // resolve()
        });
        this.zweiteFunction().then(function (value) {
            console.log('Meth 1');
            console.log(value);
            posix_1.resolve('TEST');
        });
    };
    ...
    //     return false;
    // }
    Test.prototype.zweiteFunction = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dritteFunction().then(function (value) {
                            console.log('Meth 2');
                            console.log(value);
                            posix_1.resolve('TEST');
                            return true;
    ...
    Test.prototype.dritteFunction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
